...
import tube1 from '../img/tube1.png';
...
function Planner() {
  ...
  return (
    <div class="container">
        <div className='tube-timer'>
        <div className = 'title'>
          <h4 style={{marginTop:'190px'}} >Tube Journey Planner</h4>
        </div>
        <br/>
...
export default Planner;
    ...
    //     {/* {journey.length > 0 ? (
    //   <div>
    //       <h4 className='resluts'>Your Travel Plan</h4>
    //     <p className='running-tube'> {startStation} => {endStation}</p>
    //     {/* <p className='line-info'>Use {lineData.lines.find(line => line.id === journey[0].id).name} line</p> */}
    //     {/* <img src={tube1} alt='London Tube Train' className='tube-m' />
    //   </div>
    // ) : null} */} 
